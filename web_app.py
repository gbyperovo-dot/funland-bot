...
# --- Загрузка базы знаний с улучшенной логикой ---
def load_knowledge_base():
    ...
    if os.path.exists(KNOWLEDGE_FILE):
        ...
        # --- Установка базы знаний по умолчанию ---
        KNOWLEDGE_BASE = {
            "день рождения": """
🎉 Отлично, что решили заказать день рождения! 😊

Подскажите, пожалуйста, какие у вас пожелания по организации? 🎉🎂🎁

Например:
• Количество гостей
• Тематика праздника (детский, взрослый, косплей, хэллоуин и т. д.)
• Место проведения (наши залы, выездное мероприятие)
• Пожелания по аниматорам, игре, оформлению

💡 Мы предлагаем:
• Пакеты: Стандарт (8000 ₽), Экстрим (12 000 ₽), VR-приключение (15 000 ₽)
• Акции: +10% скидка при бронировании до 15 августа!

📅 Хотите забронировать время? Напишите: *«забронировать»*  
📞 Или свяжитесь с нами по телефону: +7 (999) 123-45-67
            """,
            "хочу заказать день рождения": """
🎉 Отлично, что решили заказать день рождения! 😊
...
📞 Или свяжитесь с нами по телефону: +7 (999) 123-45-67
            """,
            "гостей 10": """
Здравствуйте! Вы хотите заказать день рождения на 10 гостей? 😊

Мы предлагаем:
• Пакеты: Стандарт (8000 ₽), Экстрим (12 000 ₽), VR-приключение (15 000 ₽)
• Акции: +10% скидка при бронировании до 15 августа!

Подскажите, пожалуйста, тематику праздника и место проведения.
...
1. Заполнить форму бронирования:  
   → <a href="/booking" style="color: #0d6efd; text-decoration: underline;">Перейти к бронированию</a>
...
• +10% скидка при бронировании дня рождения до 15 августа
• Бесплатный аниматор при заказе пакета "Экстрим" на 20+ гостей
• Скидка 15% на VR-зоны по вторникам

Успейте воспользоваться!
            """,
            "нерф": """
🔫 Добро пожаловать в Нерф-арену!
...
Напишите: *«правила в нерфе»*, *«стоимость нерф»* или *«забронировать нерф»*
            """,
            "батуты": """
🏀 Батутный центр — безопасно и весело!

Для детей от 3 лет.  
Стоимость: 500 ₽/час.  
Аниматоры, зоны для родителей.

Напишите: *«для детей?»*, *«цены батуты»* или *«забронировать батуты»*
            """
        }
        with open(KNOWLEDGE_FILE, "w", encoding="utf-8") as f:
            json.dump(KNOWLEDGE_BASE, f, ensure_ascii=False, indent=4)
        print("✅ Создана база знаний по умолчанию")
        logging.info("Создана база знаний по умолчанию")
...
- Предложи акции: +10% скидка при бронировании до 15 августа
